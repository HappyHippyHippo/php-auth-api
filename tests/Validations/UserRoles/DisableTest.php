...
class DisableTest extends EndpointTester
{
     ...
     */
    public function testInvalid(string $userId, string $roleId, array $headers, string $code, string $message): void
    {
        $this->client->request('POST', '/users/' . $userId . '/roles/' . $roleId . '/disable', [], [], $headers);
