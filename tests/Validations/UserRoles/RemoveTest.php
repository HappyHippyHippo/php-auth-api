...
class RemoveTest extends EndpointTester
{
    ...
    {
        $this->client->request('DELETE', '/users/' . $userId . '/roles/' . $roleId, [], [], $headers);
