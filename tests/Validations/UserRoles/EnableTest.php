...
class EnableTest extends EndpointTester
{
    ...
    {
        $this->client->request('POST', '/users/' . $userId . '/roles/' . $roleId . '/enable', [], [], $headers);
