...
class GetTest extends EndpointTester
{
    ...
    public function testInvalid(array $params, array $headers, string $code, string $message): void
    {
        $this->client->request(
            'GET',
            '/users/' . $params['userId'] . '/permissions/' . $params['permissionId'],
            [],
            [],
            $headers
        );
