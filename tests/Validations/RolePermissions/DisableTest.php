...
class DisableTest extends EndpointTester
{
    ...
    public function testInvalid(array $params, array $headers, string $code, string $message): void
    {
        $this->client->request(
            'POST',
            '/roles/' . $params['roleId'] . '/permissions/' . $params['permissionId'] . '/disable',
            [],
            [],
            $headers
        );
