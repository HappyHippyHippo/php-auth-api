...
class EnableTest extends EndpointTester
{
    ...
    public function testInvalid(array $params, array $headers, string $code, string $message): void
    {
        $this->client->request(
            'POST',
            '/roles/' . $params['roleId'] . '/permissions/' . $params['permissionId'] . '/enable',
            [],
            [],
            $headers
        );
